    ...
    try {
        ...
        const result = await db.query(
            `UPDATE pricing_config 
             SET base_fare = $1, per_km = $2, per_minute = $3, minimum_fare = $4, booking_fee = $5, updated_at = CURRENT_TIMESTAMP
...
router.put('/surge/:id', async (req, res) => {
    try {
        ...
        const result = await db.query(
            'UPDATE surge_multipliers SET multiplier = $1, active = $2 WHERE id = $3 RETURNING id',
...
router.put('/zones/:id', async (req, res) => {
    try {
        ...
        const result = await db.query(
            'UPDATE special_zones SET zone_name = $1, surcharge = $2, multiplier = $3, active = $4 WHERE id = $5 RETURNING id',
